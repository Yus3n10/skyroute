...
const TABS = [
  {
    id: "itineraries",
    label: "Itineraries",
    blurb: "Every way to get from one airport to another.",
  },
  {
    id: "alliances",
    label: "Alliances",
    blurb: "How the three airline partnerships compare on the same trip.",
  },
  {
    id: "explorer",
    label: "Airports",
    blurb: "Where an airport flies, and how far it gets you.",
  },
] as const;
    ...
    <div className="flex min-h-dvh flex-col">
      ...
      <header className="border-b-2 border-rule bg-paper">
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          ...
          {/* Boxed tabs sitting above the masthead rule. An earlier version pulled
              them down 2px to overlap it, which chopped the rule wherever a tab sat.
              On a very narrow screen the strip scrolls rather than the page body. */}
          <nav aria-label="Main" className="pb-3">
                ...
                return (
                  <li key={id}>
                    ...
                    <a
                      ...
                      className={`flex min-h-11 cursor-pointer items-center border-2 px-4 text-sm font-semibold tracking-wide transition-colors duration-150 ${
                        current
